...
window.PROJECT_WIDGET_CONFIG = {
  ...
  requiredFields: [
    ...
    { apiName: "Description", label: "Description", type: "textarea", editable: true },
    { apiName: "Description_of_Work_2", label: "Technical Scope (INTERNAL)", type: "textarea", editable: true },
