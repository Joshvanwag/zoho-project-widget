...
window.PROJECT_WIDGET_CONFIG = {
  ...
  fields: [
    ...
    { apiName: "proposed_start_date", label: "Customer Install Deadline Date", type: "date", source: "project", required: false, requiredWhen: { apiName: "Schedule_Expectation", equals: "By Deadline (date needed)" }, showWhen: { apiName: "Schedule_Expectation", equals: "By Deadline (date needed)" }, editable: true },
    { apiName: "Pre_Wire_Needed", label: "Pre-Wire Required", type: "picklist", source: "deal", required: true, editable: true, options: ["Yes", "No"] },
    { apiName: "pre_wire_date", label: "Pre-Wire Needed By Date", type: "date", source: "project", required: false, requiredWhen: { apiName: "Pre_Wire_Needed", equals: "Yes" }, showWhen: { apiName: "Pre_Wire_Needed", equals: "Yes" }, editable: true },
